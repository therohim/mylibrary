...
public class ExNavbarInnter extends BottomNavigationView {
    // used for animation
    ...
    public ExNavbarInnter(Context context) {
        this(context, null);
    }

    public ExNavbarInnter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExNavbarInnter(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mMenuView.updateMenuView();
     ...
     * @param viewPager
     */
    public ExNavbarInnter setupWithViewPager(final ViewPager viewPager) {
     ...
     */
    public ExNavbarInnter setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
     ...
     * necessary calls back to the provided {@link ExNavbarInnter} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<ExNavbarInnter> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(ExNavbarInnter bnve) {
        ...
        public void onPageSelected(final int position) {
            final ExNavbarInnter bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, ExNavbarInnter bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
